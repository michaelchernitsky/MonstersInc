...
namespace AuthServer.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register([FromForm]RegisterInputModel model)
        {
            ...
            var user = new AppUser { UserName = model.Username, Name = $"{model.FirstName} {model.LastName}", Email = $"{model.Username}@monstersinc.com" , ScareStartDate = model.ScareStartDate };
